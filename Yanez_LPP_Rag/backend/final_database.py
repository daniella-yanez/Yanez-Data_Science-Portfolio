...
from final_config import EMBEDDING_DIMENSION, EMBEDDING_MODEL_NAME, DEFAULT_TOP_K
#Basically the same as ... from sklearn.model_selection import train_test_split
