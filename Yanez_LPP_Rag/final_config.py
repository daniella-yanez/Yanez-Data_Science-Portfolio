...
DEFAULT_DB_PATH = "backend/inpol_vector.duckdb" # UPDATE WITH YOUR .duckdb file for database.py
DEFAULT_TOP_K = 5#10 # Default top k neighbors parameter for app.py
