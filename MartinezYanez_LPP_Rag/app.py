...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="Indiana 2026 Midterm Election RAG Assistant",
    page_icon="📖",
    layout="wide"
)
...
with st.sidebar:
    ...
    # Store in session state
    st.session_state.top_k = config.DEFAULT_DB_PATH
    ...
    with st.chat_message("assistant"):
        with st.spinner("Searching database and generating answer..."):
            try:
                ...
                #agent = "You are a helpful politics research assistant helping everyday citizens understand how their local politics are affecting their own lives and impacting the national scene."
...
# TO DO INDEPENDENTLY: Example questions in an expander
with st.expander("💡 Example Questions"):
    examples = [
        "How has Rudy Yakym voted on Medicare issues?",
        "Give me a summary of the top 5 issues Rudy Yakym supports.",
